...
Below is a screenshot of the simulation GUI. The silver hexagons are rocks, while the purple hexagons represent food. The rest of the colorful hexes are critters

![GUI Display](https://i.imgur.com/qlBtHLd.png)
