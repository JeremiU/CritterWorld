...
public interface Node extends Cloneable {
    ...
    /**
     * Returns the node at {@code index} in the AST rooted at this node.
     * Indices are defined such that:<br>
     ...
     * @throws IndexOutOfBoundsException if {@code index} is not in the range
     *                                   of valid indices
     */
     ...
     * StringBuilder.
     *
     * <p>The output of this method must be consistent with both the critter
     ...
     * {@code Node}.
     *
     * <p>This method returns the same result as {@code
    ...
    /**
     * Returns whether the AST under this node is well-formed. For use in
     * assertions.
     */
    boolean classInv();

    /**
     * accepts the specified fault injector and turns around it calls
     * its apply method.
     *
     * @param p program to call
     * @param f fault injector to injector
     * @return Maybe possibly containing successfully mutated p
     */
    Maybe<Program> accept(Program p, Fault f);
}