...
public interface Program extends Node {
    ...
    /**
     * Returns a {@code Node} in this {@code Program} whose {@code
     * NodeCategory} matches {@code type}. If no such node exists, returns
     * {@code Maybe.none}.
     *
     * @param type the
     * @return A node with category {@code type}, or {@code Maybe.none} if no
     * such node is found
     */
