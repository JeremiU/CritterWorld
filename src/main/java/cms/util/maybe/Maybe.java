...
public abstract class Maybe<T> implements Iterable<T> {
    ...
    /** Returns the contained value, if present. Otherwise, throws the
     *  exception.
    ...
    /** If a value {@code v} is present, returns {@code f(v)}. Otherwise,
     *  returns an empty {@code Maybe}.  (This is a monadic bind.)
     * <p>
     *  This method is useful for chaining together a series of {@code Maybe}
     *  accesses. For example, supposing {@code T.foo()} returns a Maybe:
     * <pre>
     * {@code
     * Maybe<T> mt = ...
     ...
     * @param <U> The type of the value that may be returned by the function
     * {@code f}.
     * @return the {@code Maybe} returned by {@code f}, if a value is contained
     *         in this {@code Maybe}. Otherwise, an empty {@code Maybe}.
     */
    public abstract <U> Maybe<U> thenMaybe(Function<T, Maybe<U>> f);

    /** If a value {@code v} is present, returns a {@code Maybe} containing
     * {@code f(v)}, which must be non-null.  Otherwise, returns an empty
     * {@code Maybe}. (This is a monadic bind composed with a monadic unit.)
     * <p>
     ...
     * @param <U> The type of the value that may be returned by the function
     * {@code f}.
     * @return a {@code Maybe} containing the value {@code f}, if a value is
     *   contained in this {@code Maybe}. Otherwise, an empty {@code Maybe}.
     */
    public abstract <U> Maybe<U> then(Function<T, U> f);
    
    /** Returns the contained value, if any; otherwise, returns {@code other}.
     *  Note: since orElse is an ordinary method call, its argument is always
     *  computed, unlike a Java {@code else} statement. If the argument is
     *  expensive to compute or has side effects, {@code orElseGet()} should
     *  be used instead.
     *  
     *  @param other The value to be returned if no value is in this {@code
     *      Maybe}.
     *  @return The contained value, or an empty {@code Maybe}.
     */
    public abstract T orElse(T other);

    /** Returns the contained value, if any; otherwise, returns {@code
     *     other.get()}.
    ...
    /** Returns the contained value, if any; otherwise, throws the specified
     *  exception. */
    public abstract <E extends Throwable> T orElseThrow(E throwable) throws E;
    
    /** Returns this if a value is contained; otherwise, returns {@code
     *  other.get()}.
     *  @param other The function to use when this {@code Maybe} is empty.
    ...
    /** If a value is contained, run consThen on the value; otherwise run
     *  procElse */
    public abstract void thenElse(Consumer<T> consThen, Runnable procElse);

    /** Provide an iterator that yields either one {@code T} or none,
     *  depending. */
    public abstract Iterator<T> iterator();

    /** True if the Maybe's contents are equal to {@code elem}, false if not or
     ...
     * @return If the {@code Optional} contains a value, then Some of that
